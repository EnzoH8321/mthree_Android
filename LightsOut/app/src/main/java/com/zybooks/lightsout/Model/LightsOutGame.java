package com.zybooks.lightsout.Model;
...
public class LightsOutGame {
    ...
    public void selectLight(int row, int col) {
        ...
        if (row == 0 && col == 0) {
            this.cheatPresses = this.cheatPresses + 1;
            if (this.cheatPresses >= 5) {
                for (int rowIn = 0; rowIn < GRID_SIZE; rowIn++) {
                    for (int colIn = 0; colIn < GRID_SIZE; colIn++) {
                        mLightsGrid[rowIn][colIn] = false;
                    }
                }
                return;
            } else {
...
//    public void cheatTrick(int index) {
//
//        if (index == 0) {
//            if (this.cheatPresses >= 5) {
//                for (int row = 0; row < GRID_SIZE; row++) {
